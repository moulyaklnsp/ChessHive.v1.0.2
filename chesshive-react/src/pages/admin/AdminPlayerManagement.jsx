      ...
      <div className="page player-neo">
        ...
        <div className="content">
          ...
          >
            ...
            {loading ? (
              <table className="table"><tbody><tr><td colSpan={4} className="empty"><i className="fas fa-info-circle" /> Loading players…</td></tr></tbody></table>
            ) : (
              <>
                <table className="table">
                  ...
                  <tbody>
                    {shown.length === 0 ? (
                      <tr><td colSpan={4} className="empty"><i className="fas fa-info-circle" /> No players available.</td></tr>
                    ) : (
                      shown.map((p, idx) => (
                        <tr key={`${p.email}-${idx}`}>
