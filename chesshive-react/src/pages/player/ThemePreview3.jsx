...
function ThemePreview3() {
  const [isDarkMode, setIsDarkMode] = useState(false);
  
  // Theme 3: Sunset Glow (Light) and Fire Orange (Dark)
  const lightTheme = lightThemes.sunset;
  const darkTheme = darkThemes.fireOrange;
    ...
    <div className="theme-preview-container" style={{ 
      ...
      <div className="theme-header" style={{
        ...
        boxShadow: isDarkMode 
          ? `0 4px 20px rgba(0, 0, 0, 0.5), 0 0 30px ${currentTheme.colors.primary}50`
        ...
        <div className="mode-toggle" style={{ marginBottom: '1.5rem', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          ...
          <button 
            ...
            style={{
              ...
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              boxShadow: isDarkMode ? `0 4px 15px ${currentTheme.colors.primary}50` : 'none'
            }}
          >
        ...
        <div style={{
          ...
          <div style={{
            ...
            minWidth: '120px',
            textAlign: 'center',
            boxShadow: isDarkMode ? `0 0 20px ${currentTheme.colors.primary}60` : 'none'
          }}>
          ...
          <div style={{
            ...
            <div style={{ fontWeight: 700, color: isDarkMode ? '#000' : '#000', marginBottom: '0.5rem' }}>ACCENT</div>
            <code style={{ color: isDarkMode ? '#000' : '#000', fontSize: '0.75rem' }}>{currentTheme.colors.accent}</code>
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          transition: 'all 0.3s ease',
          boxShadow: isDarkMode 
            ? `0 4px 20px rgba(0, 0, 0, 0.5), 0 0 25px ${currentTheme.colors.primary}50`
            : `0 4px 20px rgba(0, 0, 0, 0.1)`,
          position: 'relative',
          overflow: 'hidden'
        }}
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = isDarkMode 
            ? `0 8px 30px rgba(0, 0, 0, 0.6), 0 0 40px ${currentTheme.colors.primary}60`
            : `0 8px 30px ${currentTheme.colors.primary}30`;
        ...
        >
          <h3 style={{
            ...
            paddingLeft: '1rem',
            textShadow: isDarkMode ? `0 0 10px ${currentTheme.colors.primary}40` : 'none'
          }}>
            Card Component
          </h3>
          <p style={{ color: currentTheme.colors.text, marginBottom: '1rem', lineHeight: '1.7' }}>
            This is how cards look in <strong>{currentTheme.name}</strong>. Notice the warm, energetic styling.
            {isDarkMode && ' With fiery orange glow effects for intense gameplay.'}
          </p>
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
            <button style={{
              ...
              fontWeight: 600,
              cursor: 'pointer',
              boxShadow: `0 4px 15px ${currentTheme.colors.primary}60`,
              transition: 'all 0.3s ease'
            }}
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = `0 6px 20px ${currentTheme.colors.primary}70`;
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'translateY(0)';
              e.target.style.boxShadow = `0 4px 15px ${currentTheme.colors.primary}60`;
            }}
            >
              Primary Button
            </button>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <span style={{
              ...
              fontSize: '0.9rem',
              fontWeight: 600,
              boxShadow: isDarkMode ? `0 0 10px ${currentTheme.colors.primary}40` : 'none'
            }}>Warning</span>
            <span style={{
              padding: '0.5rem 1rem',
              borderRadius: '20px',
        ...
        <div style={{
          ...
          <div style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = `rgba(${currentTheme.colors.primaryRgb}, 0.15)`;
              e.currentTarget.style.transform = 'translateX(5px)';
              e.currentTarget.style.borderColor = currentTheme.colors.primary;
              e.currentTarget.style.boxShadow = `0 0 15px ${currentTheme.colors.primary}30`;
            }}
            onMouseLeave={(e) => {
            ...
            >
              ...
              <button style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                boxShadow: `0 4px 10px ${currentTheme.colors.primary}50`,
                transition: 'all 0.3s ease'
              }}
              onMouseEnter={(e) => {
                e.target.style.transform = 'scale(1.05)';
                e.target.style.boxShadow = `0 6px 15px ${currentTheme.colors.primary}60`;
              }}
              onMouseLeave={(e) => {
                e.target.style.transform = 'scale(1)';
                e.target.style.boxShadow = `0 4px 10px ${currentTheme.colors.primary}50`;
              }}
              >
                Join
              </button>
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            WebkitTextFillColor: 'transparent',
            marginBottom: '0.5rem',
            textShadow: isDarkMode ? `0 0 20px ${currentTheme.colors.primary}50` : 'none'
          }}>Heading 1</h1>
          ...
          <h2 style={{
            ...
            color: currentTheme.colors.primary,
            marginBottom: '0.5rem',
            textShadow: isDarkMode ? `0 0 15px ${currentTheme.colors.primary}40` : 'none'
          }}>Heading 2</h2>
      ...
      <div style={{
        ...
        margin: '3rem auto 0',
        boxShadow: isDarkMode 
          ? `0 4px 20px rgba(0, 0, 0, 0.5), 0 0 30px ${currentTheme.colors.primary}60`
          : `0 4px 20px rgba(0, 0, 0, 0.1)`
      }}>
        <button 
          ...
          style={{
            ...
            borderRadius: '12px',
            cursor: 'pointer',
            boxShadow: `0 8px 30px ${currentTheme.colors.primary}60`,
            transition: 'all 0.3s ease'
          }}
          onMouseEnter={(e) => {
            e.target.style.transform = 'translateY(-3px) scale(1.05)';
            e.target.style.boxShadow = `0 12px 40px ${currentTheme.colors.primary}80`;
          }}
          onMouseLeave={(e) => {
            e.target.style.transform = 'translateY(0) scale(1)';
            e.target.style.boxShadow = `0 8px 30px ${currentTheme.colors.primary}60`;
          }}
        >
          ✅ Finalize This Theme
        </button>
