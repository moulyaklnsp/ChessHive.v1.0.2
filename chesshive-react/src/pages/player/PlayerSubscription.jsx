...
function PlayerSubscription() {
  ...
  const styles = {
    ...
    h2: { fontFamily: 'Cinzel, serif', color: isDark ? 'var(--text-color)' : 'var(--sea-green)', textAlign: 'center' },
    card: { background: 'var(--card-bg)', borderRadius: 10, padding: 25, margin: '20px 0', boxShadow: 'var(--card-shadow)', transition: 'transform 0.3s ease', border: '1px solid var(--card-border)' },
    wallet: { backgroundColor: 'var(--sea-green)', color: 'var(--on-accent)', padding: 20, borderRadius: 10, textAlign: 'center', marginBottom: '1.5rem', overflow: 'hidden' },
    ...
    error: { backgroundColor: 'var(--error)', color: 'var(--on-accent)', padding: 15, borderRadius: 5, marginBottom: 20, textAlign: 'center' },
    backRow: { textAlign: 'center', marginTop: '2rem' },
    backLink: { backgroundColor: 'var(--sky-blue)', color: 'var(--on-accent)', border: 'none', padding: '12px 24px', borderRadius: 5, cursor: 'pointer', fontWeight: 'bold', transition: 'all 0.3s ease', width: 'auto', fontFamily: 'Cinzel, serif', textDecoration: 'none', display: 'inline-block', textAlign: 'center' },
    price: { fontSize: 24, fontWeight: 'bold', color: isDark ? 'var(--text-color)' : 'var(--sea-green)', margin: '15px 0' },
    ul: { listStyle: 'none', padding: 0, margin: '15px 0' },
    li: { padding: '8px 0', borderBottom: '1px solid var(--border-color)' },
  };
