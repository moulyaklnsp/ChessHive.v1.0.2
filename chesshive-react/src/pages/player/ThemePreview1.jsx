...
function ThemePreview1() {
  const [isDarkMode, setIsDarkMode] = useState(false);
  
  // Theme 1: Emerald Elegance (Light) and Neon Cyan (Dark)
  const lightTheme = lightThemes.emerald;
  const darkTheme = darkThemes.neonCyan;
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: isDarkMode 
            ? `0 4px 20px rgba(0, 0, 0, 0.5), 0 0 20px ${currentTheme.colors.primary}33`
